            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                ...
                <Link
                    ...
                    <div class="flex flex-col">
                        ...
                        <h3 class="text-2xl font-semibold tracking-tight text-zinc-900 dark:text-white">{{ formatRupiah(totalIncome) }}
                        </h3>
                    </div>
                </Link>
                ...
                <Link
                    ...
                    <div class="flex flex-col">
                        ...
                        <h3 class="text-2xl font-semibold tracking-tight text-zinc-900 dark:text-white">{{ totalTransactions }} <span
                ...
                <Link
                    ...
                    <div class="flex flex-col">
                        ...
                        <h3 class="text-2xl font-semibold tracking-tight text-zinc-900 dark:text-white">{{ activeBranches }} <span
                                class="text-sm font-normal text-zinc-500">/ {{ activeBranches }} Buka</span></h3>
                    </div>
                </Link>
                        ...
                        <div
                            ...
                            <div class="flex items-center justify-between mb-6">
                                ...
                                <div
                                    ...
                                    <button
                                        @click="performanceTab = 'transaksi'"
                                        ...
                                        >
                                            <td class="py-4 pl-2">
                                                <div class="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        <p class="text-zinc-900 dark:text-zinc-200 font-medium">{{ branch.name }}</p>
                                            ...
                                            <td class="py-4 text-right text-zinc-700 dark:text-zinc-300 font-medium">
                                                {{ performanceTab === 'omset' ? formatRupiah(branch.total_income) : branch.transaction_count + ' Transaksi' }}
                                            </td>
                                            <td class="py-4 text-center">
                                                <span class="text-zinc-700 dark:text-zinc-300 font-medium">{{ branch.transaction_count }}</span>
                                            </td>
                                            <td class="py-4 text-right pr-2">
                                                <span class="text-xs text-zinc-500 dark:text-zinc-400">{{ branch.latest_activity }}</span>
                                            </td>
                                        </tr>
                    ...
                    <div class="flex flex-col gap-6">
                        ...
                        <div
                            ...
                            <div class="space-y-4">
                                ...
                                <div v-for="(item, index) in topSellingMenus" :key="index" class="flex items-center gap-3">
                                    <div class="h-10 w-10 flex items-center justify-center bg-zinc-100 dark:bg-zinc-800 rounded-lg text-lg">
                                        {{ item.icon || '🍽️' }}
                                    </div>
                            ...
                            <div class="mt-6 flex justify-center">
                                <Link href="/admin/menu" class="text-xs text-orange-500 hover:text-orange-600 font-medium cursor-pointer">Lihat Analisa Menu</Link>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div class="space-y-0 relative">
                                <!-- Timeline line -->
                                <div v-if="latestTransactions.length > 0" class="absolute left-2 top-2 bottom-2 w-px bg-zinc-200 dark:bg-zinc-800"></div>
                                ...
                                <!-- Dynamic Orders -->
                                <div 
                                    v-for="(order, index) in latestTransactions" 
                                    :key="order.id"
                                    class="relative pl-6"
                                ...
                                >
                                    ...
                                    <div class="flex justify-between items-start">
                                        <div>
                                            ...
                                            >{{ order.items }}</p>
                                            <p class="text-xs text-zinc-500">Cabang: {{ order.branch_name }} • {{ order.order_number }}</p>
                                        </div>
                                        <span 
